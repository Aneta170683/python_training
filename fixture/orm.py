...
class ORMFixture:
    ...
    def __init__(self, host, name, user, password):
        ...
        #elf.db.bind('mysql', host=host, database=name, user=user, password=password, conv=decoders)
    ...
    def get_contact(self, contact):
        return self.convert_contacts_to_model(select(c for c in ORMFixture.ORMContact if c.id == contact.id))[0]
    ...
    @db_session
    def get_contact_in_group(self, group_id, contact_id):
